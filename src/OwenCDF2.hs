      ...
      case nu < 1 of
        ...
        False -> do
          ...
          case length higher == n of
            True -> _owenCDF2 nu t1 t2 delta1 delta2
            False -> do
              ...
              case length equal == n of
                ...
                False -> do
                  ...
                  case length lower == n of
                    True -> _owenCDF4 nu t2 t1 delta2 delta1
                    False -> do
                      out0 <- _owenCDF2 nu t1 t2 [delta1 !! i | i <- higher]
                                                 [delta2 !! i | i <- higher]
                      out1 <- f [delta1 !! i | i <- equal]
                      out2 <- _owenCDF4 nu t2 t1 [delta2 !! i | i <- lower]
                                                 [delta1 !! i | i <- lower]
